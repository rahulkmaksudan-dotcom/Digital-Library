    ...
    <ToastContext.Provider value={{ showToast, success, error, info, warning }}>
      ...
      <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-2 max-w-md w-full pointer-events-none p-4">
        {toasts.map((t) => (
          <div
            key={t.id}
            className={`pointer-events-auto flex items-start gap-3 p-4 rounded-xl shadow-lg border backdrop-blur transition-all duration-300 transform translate-y-0 ${
              t.type === 'success'
